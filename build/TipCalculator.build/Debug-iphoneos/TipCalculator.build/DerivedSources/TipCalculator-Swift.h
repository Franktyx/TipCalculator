...
@property (nonatomic, strong) UITextField * __null_unspecified inputTextField;
@property (nonatomic, strong) UIToolbar * __null_unspecified inputToolBar;
@property (nonatomic, strong) UILabel * __null_unspecified tipLabel;
@property (nonatomic, strong) UILabel * __null_unspecified tipAmountLabel;
@property (nonatomic, strong) UILabel * __null_unspecified totalLabel;
@property (nonatomic, strong) UILabel * __null_unspecified totalAmountLabel;
@property (nonatomic, strong) UISlider * __null_unspecified tipPercentSlider;
@property (nonatomic, strong) UILabel * __null_unspecified pickerLabel;
@property (nonatomic, strong) UIPickerView * __null_unspecified numberOfPartyPicker;
@property (nonatomic, copy) NSArray<NSString *> * __nonnull pickerDataSource;
@property (nonatomic, strong) UILabel * __null_unspecified individualAmountLabel;
@property (nonatomic, strong) UILabel * __null_unspecified individualAmount;
@property (nonatomic, strong) UILabel * __null_unspecified individualTipLabel;
@property (nonatomic, strong) UILabel * __null_unspecified individualTip;
- (void)viewDidLoad;
- (void)textFieldSetup;
- (void)labelSetup;
- (void)sliderSetup;
...
- (void)rightBarButtonItemOnClick:(UIBarButtonItem * __nonnull)sender;
- (void)reloadAmount;
